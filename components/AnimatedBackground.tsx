...
export default function AnimatedBackground({ onLoaded }: { onLoaded?: () => void }) {
  ...
  // Handle Keycap Mouse Hover / Clicks
  ...
  // Bongo Cat Typing Animation Controller
  const startBongoCat = () => {
    if (!splineApp) return;
  ...
  // Keycap Explosion / Floating Animation for Stack section
  ...
  // Handle active section animations (Bongo cat & keycaps)
  useEffect(() => {
  ...
  function onLoad(app: Application) {
    ...
    // Make sure keyboard and keycaps are visible
    try {
